    ...
    @endif
      <div class="table-responsive">
                ...
                <tr>
                  ...
                  <td>{{$post->phone}}</td>
                  <td>
                        <form action="{{route('assign.writer.delete')}}" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{$post->id}}">
                    <button class="btn btn-danger btn-sm rounded-0" type="submit" data-toggle="tooltip" data-placement="top" title="Remove">Remove</button>
                        </form>
                  </td>
                </tr>
                @endif
