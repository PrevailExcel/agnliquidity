<title>Login to your access your dashboard</title>
...
.bg {
  /* The image used */
  background-image: url("{{asset('/dist/img/we_do_bg.png')}}");
...
<body class="bg" style="opacity:0.8; background-size:cover;">
        <div class="container">
            ...
            <div class="col-lg-6" style="background-color:#fff; alignment-adjust:central; text-align:center; padding:50px;">
								<h2 style="text-align:center">User Sign In</h2>
								<form id="signupPopupForm" style="opacity:1;  " form method="POST" action="{{ route('login') }}" class="form-horizontal">
                                                    @csrf
